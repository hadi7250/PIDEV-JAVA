...
public class UserBasicPageController implements Initializable {
    ...
    private entities.User loggedInUser;
    ...
    public void setLoggedInUser(entities.User user) {
    ...
    void refreshProfile() {
        ...
        entities.User refreshedUser = userService.getUserById(loggedInUser.getId());
