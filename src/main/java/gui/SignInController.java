...
public class SignInController {
    ...
    private void navigateToDashboard(User user) {
        try {
            ...
            if (user.isAdmin()) {
                // Admin goes to Admin Home Dashboard
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AdminHomeDashboard.fxml"));
                ...
                // Regular user goes to User Home Dashboard
