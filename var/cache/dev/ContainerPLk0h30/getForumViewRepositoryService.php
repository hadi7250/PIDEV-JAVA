 ...
 */
class getForumViewRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumViewRepository' shared autowired service.
     *
     * @return \App\Repository\ForumViewRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumViewRepository.php';

        return $container->privates['App\\Repository\\ForumViewRepository'] = new \App\Repository\ForumViewRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
