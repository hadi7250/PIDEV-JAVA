 ...
 */
class getForumDiscussionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumDiscussionRepository' shared autowired service.
     *
     * @return \App\Repository\ForumDiscussionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumDiscussionRepository.php';

        return $container->privates['App\\Repository\\ForumDiscussionRepository'] = new \App\Repository\ForumDiscussionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
