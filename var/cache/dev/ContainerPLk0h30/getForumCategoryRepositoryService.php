 ...
 */
class getForumCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\ForumCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumCategoryRepository.php';

        return $container->privates['App\\Repository\\ForumCategoryRepository'] = new \App\Repository\ForumCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
