 ...
 */
class getForumVoteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumVoteRepository' shared autowired service.
     *
     * @return \App\Repository\ForumVoteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumVoteRepository.php';

        return $container->privates['App\\Repository\\ForumVoteRepository'] = new \App\Repository\ForumVoteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
