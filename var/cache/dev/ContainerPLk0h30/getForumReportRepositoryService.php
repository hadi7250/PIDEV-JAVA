 ...
 */
class getForumReportRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumReportRepository' shared autowired service.
     *
     * @return \App\Repository\ForumReportRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumReportRepository.php';

        return $container->privates['App\\Repository\\ForumReportRepository'] = new \App\Repository\ForumReportRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
