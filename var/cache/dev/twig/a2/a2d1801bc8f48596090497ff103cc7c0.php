...
/* dashboard/user_add.html.twig */
class __TwigTemplate_c6eec513786c4a8256907f3d829ed1bb extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashboard/user_add.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashboard/user_add.html.twig"));
                ...
                <div class=\"card\">
                    <div class=\"card-header d-flex justify-content-between align-items-center\">
                        ...
                        <div class=\"d-flex gap-2\">
                            ...
                            <button class=\"btn btn-info px-4\" data-bs-toggle=\"modal\" data-bs-target=\"#chatBotModal\">
                                <i class=\"material-icons-outlined me-2\">smart_toy</i>Chat Bot IA
                            </button>
...
let users = ";
        // line 301
        yield json_encode((isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 301, $this->source); })()));
        yield ";
        ...
        yield "\" class=\"rounded-circle\" width=\"40\" height=\"40\" alt=\"\">
                ...
                <td>
                    <div class=\"d-flex gap-2\">
                        ...
                        <button class=\"btn btn-sm btn-outline-danger\" onclick=\"deleteUser(\${user.id}, '\${fullName}')\" title=\"Delete\">
...
function editUser(userId) {
    ...
    console.log('Parsed data:', { firstName, lastName, email: user.email, role });
...
function filterUsers() {
    ...
    filteredUsers = users.filter(user => {
        ...
        // Status matches (use actual user status)
        ...
        <div class=\"modal-content\">
            <div class=\"modal-header bg-primary text-white\">
                <h5 class=\"modal-title\" id=\"chatBotModalLabel\">
                    <i class=\"material-icons-outlined me-2\">smart_toy</i>Assistant IA Groq - Stats utilisateurs
                </h5>
                <button type=\"button\" class=\"btn-close btn-close-white\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>
            </div>
            <div class=\"modal-body\">
                <div id=\"chatMessages\" style=\"height:400px; overflow-y:auto; border:1px solid #ddd; padding:1rem; margin-bottom:1rem; background-color: #f8f9fa; border-radius:0.5rem;\">
                    <div class=\"message bot\">
                        <i class=\"material-icons-outlined me-2\">psychology</i>
                        Bonjour Admin ! Je suis votre assistant IA Groq avec Llama 3.1. Posez-moi une question sur les utilisateurs (ex: \"Combien d'utilisateurs actifs ?\", \"Stats par rôle\", \"Nombre d'inscrits ce mois ?\")
                    </div>
                </div>
                <form id=\"chatForm\">
                    <div class=\"input-group\">
                        <input type=\"text\" id=\"chatInput\" class=\"form-control\" placeholder=\"Posez votre question sur les statistiques utilisateurs...\" autocomplete=\"off\">
                        <button type=\"submit\" class=\"btn btn-info\">
                            <i class=\"material-icons-outlined me-1\">send</i>Envoyer
                        </button>
                    </div>
                </form>
            </div>
            <div class=\"modal-footer\">
                <small class=\"text-muted\">
                    ...
                    Powered by Groq (Llama 3.1) - Ultra-rapide, 100% gratuit, réponses basées sur les données réelles
                </small>
            </div>
        </div>
    </div>
...
document.getElementById('chatForm').addEventListener('submit', function(e) {
    ...
    messages.innerHTML += `
        <div class=\"message bot\" id=\"\${loadingId}\">
            <i class=\"material-icons-outlined me-2\">smart_toy</i>
    ...
    .then(data => {
        ...
        messages.innerHTML += `
            <div class=\"message bot\">
                <i class=\"material-icons-outlined me-2\">smart_toy</i>
                <strong>Groq :</strong> \${data.response}
            </div>
        `;
        messages.scrollTop = messages.scrollHeight;
    })
    .catch(error => {
        ...
        messages.innerHTML += `
            <div class=\"message bot\" style=\"background-color: #ffebee; border-left-color: #f44336; color: #c62828;\">
                <i class=\"material-icons-outlined me-2\">error</i>
                <strong>Erreur :</strong> \${error.message || 'Impossible de contacter le serveur'}
            </div>
        `;
        messages.scrollTop = messages.scrollHeight;
    });
...
";
    ...
    {
        return "dashboard/user_add.html.twig";
    }
    ...
    {
        return array (  708 => 595,  649 => 539,  526 => 419,  467 => 365,  400 => 301,  110 => 14,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock page_content %}", "dashboard/user_add.html.twig", "C:\\Users\\LordKiller\\Downloads\\user\\templates\\dashboard\\user_add.html.twig");
    }
}
